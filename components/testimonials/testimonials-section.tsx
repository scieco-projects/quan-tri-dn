...
const testimonials = [
  {
    quote: "Tôi đã có thể an tâm về quá trình rèn luyện của con mình.",
    author: "Quản Hữu Nhật Minh",
    role: "CTO ở Technology",
    avatar: "SC",
    color: "bg-teal",
  },
  {
  ...
  {
    quote: "Con được học rất nhiều điều từ trường và các thầy cô rất chu đáo.",
    author: "Phùng Thanh Quang",
    role: "Học sinh",
    avatar: "EW",
    color: "bg-gold",
  },
